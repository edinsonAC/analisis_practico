...
for /l %%i in (1,1,%NUM_RUNS%) do (
	...
	java MatrizLoca.java < resultados\matriz_2_2\matriz%%i.txt > resultados\matriz_2_2\resultado%%i.txt
	...
	java MatrizLoca.java < resultados\matriz_5_5\matriz%%i.txt > resultados\matriz_5_5\resultado%%i.txt
	...
	java MatrizLoca.java < resultados\matriz_10_10\matriz%%i.txt > resultados\matriz_10_10\resultado%%i.txt
	...
	java MatrizLoca.java < resultados\matriz_50_50\matriz%%i.txt > resultados\matriz_50_50\resultado%%i.txt
	...
	java MatrizLoca.java < resultados\matriz_100_100\matriz%%i.txt > resultados\matriz_100_100\resultado%%i.txt

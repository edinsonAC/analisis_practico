...
for /l %%i in (1,1,%NUM_RUNS%) do (
    ...
    MatrizLoca.exe < resultados\matriz_2_2\matriz%%i.txt > resultados\matriz_2_2\resultado%%i.txt
    ...
    MatrizLoca.exe < resultados\matriz_5_5\matriz%%i.txt > resultados\matriz_5_5\resultado%%i.txt
    ...
    MatrizLoca.exe < resultados\matriz_10_10\matriz%%i.txt > resultados\matriz_10_10\resultado%%i.txt
    ...
    MatrizLoca.exe < resultados\matriz_50_50\matriz%%i.txt > resultados\matriz_50_50\resultado%%i.txt
    ...
    MatrizLoca.exe < resultados\matriz_100_100\matriz%%i.txt > resultados\matriz_100_100\resultado%%i.txt
